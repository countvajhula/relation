...
(module+ test
  ...
  ;; =/classes
  (check-equal? (->set (=/classes (list 1 2 3))) (->set '((1) (2) (3))) "monotonically increasing")
  (check-equal? (->set (=/classes (list 1 1 2))) (->set '((1 1) (2))) "monotonically nondecreasing")
  (check-equal? (->set (=/classes (list 3 3 3))) (->set '((3 3 3))) "equal")
  (check-equal? (->set (=/classes (list 3 3 1))) (->set '((1) (3 3))) "monotonically nonincreasing")
  (check-equal? (->set (=/classes (list 3 2 1))) (->set '((1) (2) (3))) "monotonically decreasing")
  (check-equal? (->set (=/classes (list 3 2 4))) (->set '((2) (3) (4))) "disordered")
  (check-equal? (->set (=/classes (list 3))) (->set '((3))) "trivial case")
  (check-exn exn:fail?
             (lambda ()
               (=/classes)) "generic relations require at least one argument")
  (check-equal? (->set (=/classes (list "apple" "banana" "cherry"))) (->set '(("apple") ("banana") ("cherry"))))
  (check-equal? (->set (=/classes (list "apple" "apple" "apple"))) (->set '(("apple" "apple" "apple"))))
  (check-equal? (->set (=/classes (list "cherry" "banana" "apple"))) (->set '(("apple") ("banana") ("cherry"))))
  (check-equal? (->set (=/classes (list #"apple" #"banana" #"cherry"))) (->set '((#"apple") (#"banana") (#"cherry"))))
  (check-equal? (->set (=/classes (list #"apple" #"apple" #"apple"))) (->set '((#"apple" #"apple" #"apple"))))
  (check-equal? (->set (=/classes (list #"cherry" #"banana" #"apple"))) (->set '((#"apple") (#"banana") (#"cherry"))))
  (check-equal? (->set (=/classes (list #\a #\b #\c))) (->set '((#\a) (#\b) (#\c))))
  (check-equal? (->set (=/classes (list #\a #\a #\a))) (->set '((#\a #\a #\a))))
  (check-equal? (->set (=/classes (list #\c #\b #\a))) (->set '((#\a) (#\b) (#\c))))
  (check-equal? (->set (=/classes (list (set) (set 1) (set 1 2)))) (set (list (set)) (list (set 1)) (list (set 1 2))))
  (check-equal? (->set (=/classes (list (set 1 2) (set 1 2) (set 1 2)))) (set (list (set 1 2) (set 1 2) (set 1 2))))
  (check-equal? (->set (=/classes (list (set 1 2) (set 1) (set)))) (set (list (set)) (list (set 1)) (list (set 1 2))))
  (check-equal? (->set (=/classes (list (set 1 2) (set 1 3)))) (set (list (set 1 2)) (list (set 1 3))) "incomparable sets")
  (check-equal? (->set (=/classes (list (set 1 2) (set 3 4)))) (set (list (set 1 2)) (list (set 3 4))) "incomparable sets")
  (check-equal? (->set (=/classes #:key string-length (list "z" "yy" "xxx"))) (->set '(("z") ("yy") ("xxx"))))
  (check-equal? (->set (=/classes #:key string-length (list "xxx" "zzz" "yyy"))) (->set '(("xxx" "zzz" "yyy"))))
  (check-equal? (->set (=/classes #:key string-length (list "xxx" "yy" "z"))) (->set '(("z") ("yy") ("xxx"))))
  (check-equal? (->set (=/classes #:key odd? (list 2 3 4 5 7))) (->set '((2 4) (3 5 7))))
  ...
  (check-equal? (id (stream 1 2 3) ..) (list))
  ;; addition
