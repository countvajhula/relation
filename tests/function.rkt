...
(define tests
  (test-suite
   ...
   (check-equal? (function-arguments (curry + 1 2 3)) (make-arguments (list 1 2 3) (hash)))
   (check-equal? (function-arguments (curry = #:key string-upcase "apple")) (make-arguments (list "apple") (hash '#:key string-upcase)))
