...
(define tests
  (test-suite
   ...
   (let ([str-append-3 (procedure-reduce-arity string-append 3)])
     ...
     (check-equal? (((curryr str-append-3 "there") " ") "hello") "hello there")
     (check-equal? ((curryr str-append-3 " " "there") "hello") "hello there")
     (check-equal? (length (arguments-positional (function-combined-arguments (((curryr str-append-3 "there") " "))))) 2 "invoking with incomplete args")
   ...
   (check-equal? (function-combined-arguments (curry + 1 2 3)) (make-arguments (list 1 2 3) (hash)))
   (check-equal? (function-combined-arguments (curry = #:key string-upcase "apple")) (make-arguments (list "apple") (hash '#:key string-upcase)))
